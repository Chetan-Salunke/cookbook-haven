        ...
        <footer className="text-gray-600 body-font bg-[#F7F7F7]">
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    ...
                    <img src="/Media/navicon.svg" className="w-10 h-10 text-white rounded-full" alt="" href="/" />
                        <span className="ml-3 text-xl custom-font">Pinch of Taste</span>
                    </a>
                    <p className="mt-2 text-sm text-[#734060]">Air plant banjo lyft occupy retro adaptogen indego</p>
                </div>
            ...
            <div className="bg-[#734060]">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-[#e6e6e6] text-sm text-center sm:text-left">© 2024 Pinch of Taste —
                        <a href="https://chetan-salunke.github.io/Portfolio/" rel="noopener noreferrer" className="text-[#e6e6e6] ml-1" target="_blank">@Chetan Salunke</a>
                    </p>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                        <a className="text-[#e6e6e6]" href='https://chetan-salunke.github.io/Portfolio/'>
                        ...
                        <a className="ml-3 text-[#e6e6e6]" href='https://www.instagram.com/_chetan_salunke/?hl=en'>
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                                <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                                <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
                            </svg>
                        </a>
                        <a className="ml-3 text-[#e6e6e6]" href='https://www.linkedin.com/in/chetan-salunke-6a70341bb/'>
